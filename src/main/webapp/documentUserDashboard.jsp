...
<html>
   ...
   <body class="hold-transition skin-blue sidebar-mini">
         ...
         <div class="content-wrapper">
            ...
            <section class="content">
               ...
               <div class="box box-primary">
                  <!-- /.box-header -->
                  <!-- form start -->
                  <form role="form" method="POST" action="${contextPath}/d/upload" enctype="multipart/form-data">
                     <div class="box-body">
                        <div class="form-group">
                           <label for="documenttitle">Document Title</label>
                           <input type="text" name="documenttitle" class="form-control" id="documenttitle" placeholder="Document Title">
                        </div>
                        <div class="form-group">
                           <label for="documentshortdescription">Document Description</label>
                           <textarea class="form-control" name="documentshortdescription" id="documentshortdescription" placeholder="Document Description" ></textarea>
                        </div>
                        <div class="form-group">
      ...
      <script type="text/javascript" src="${contextPath}/resources/devJs/documentUserDashboard.js"></script>
   </body>
</html>